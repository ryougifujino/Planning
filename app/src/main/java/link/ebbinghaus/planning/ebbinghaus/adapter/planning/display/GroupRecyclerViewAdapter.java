package link.ebbinghaus.planning.ebbinghaus.adapter.planning.display;
...
import link.ebbinghaus.planning.view.planning.display.activity.PlanningDisplayEventGroupDetailActivity;
...
public class GroupRecyclerViewAdapter extends RecyclerView.Adapter<GroupRecyclerViewAdapter.ViewHolder>{
    ...
    public GroupRecyclerViewAdapter(Context context, boolean flag) {
        ...
        mEventGroups = mPlanningDisplayModel.findAllEventGroup(mEventGroupType);
    }
