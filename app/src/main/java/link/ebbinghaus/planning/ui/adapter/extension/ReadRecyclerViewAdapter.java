...
import link.ebbinghaus.planning.ui.view.common.activity.CommonWebViewActivity;
        ...
        public void onClick(View v) {
            ...
            builder.setTitle("详情")
                    ...
                    .setNegativeButton("前往", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            CommonWebViewActivity.startAction(mContext,book.getAlt());
                        }
                    });
