package link.ebbinghaus.planning.view.planning.done.activity;
...
import link.ebbinghaus.planning.ebbinghaus.constant.entity.LearningEventGroupConstant;
import link.ebbinghaus.planning.ebbinghaus.util.CommonUtils;
...
import link.ebbinghaus.planning.presenter.planning.done.impl.PlanningDoneFinishPresenterImpl;
...
public class PlanningDoneFinishActivity extends BaseActivity implements PlanningDoneFinishView,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_planning_done_finish, menu);
