package link.ebbinghaus.planning.view.planning.done.fragment;
...
import link.ebbinghaus.planning.ebbinghaus.adapter.planning.done.FinishRecyclerViewAdapter;
import link.ebbinghaus.planning.model.entity.po.Event;
import link.ebbinghaus.planning.presenter.planning.done.PlanningDonePresenter;
import link.ebbinghaus.planning.presenter.planning.done.impl.PlanningDonePresenterImpl;
...
public class PlanningDoneFragment extends BaseFragment implements PlanningDoneView {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.menu_planning_done,menu);
